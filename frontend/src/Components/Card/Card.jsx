...
const Card = ({contact,dispatch,deleteSingleUser,allChecked,setAllChecked}) => {
    ...
    <>
      <div className="card">
        ...
        <div className="card-buttons">
          ...
          <div>
            <input className="card-checkbox" type="checkbox" name="" id="" checked={singleChecked} onClick={onChangeHandler}/>
          </div>
        </div>
      </div>
    </>
